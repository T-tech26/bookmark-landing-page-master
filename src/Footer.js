...
const Footer = () => {
  ...
  return (
    <footer
      className=' w-full h-auto px-12 lg:px-36 py-5 bg-Very-Dark-Blue flex flex-col items-center gap-5'
    >
      <div
      ...
      >
        ...
        >
          <svg 
            className={
              'fill-white hover:fill-Soft-Red'
            }
      ...
      <p
        className=' text-sm text-white sm:self-start text-center'
      >
        Challenge by <a 
